...
def create_board(board):
    board[0] = [Piece('b', 'r', 5, 'b_rook.png'), Piece('b', 'kn', 11, 'b_knight.png'), Piece('b', 'b', 7, 'b_bishop.png'),
                Piece('b', 'q', 3, 'b_queen.png'), Piece('b', 'k', 9, 'b_king.png'), Piece('b', 'b', 7, 'b_bishop.png'),
                Piece('b', 'kn', 11, 'b_knight.png'), Piece('b', 'r', 5, 'b_rook.png')]

    board[7] = [Piece('w', 'r', 6, 'w_rook.png'), Piece('w', 'kn', 12, 'w_knight.png'), Piece('w', 'b', 8, 'w_bishop.png'),
                Piece('w', 'q', 4, 'w_queen.png'), Piece('w', 'k', 10, 'w_king.png'), Piece('w', 'b', 8, 'w_bishop.png'),
                ...
                if selected == False:
                    ...
                    try:
                        if board[x][y].killable == True:
                            ...
                            moves += 1
                            print(convert_to_readable(board), convert_to_ai(board))
                        else:
                            deselect()
                            remove_highlight(grid)
                            selected = False
